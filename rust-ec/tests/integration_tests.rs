...
mod tests
{
  ...
  //   assert_eq!(
  //     curve.transform_proj_point(&curve.proj_point_add(&p1, &p2)).unwrap(),
  //     EcPointP::new(&BigInt::from(11), &BigInt::from(4), &BigInt::from(1))
  //   );
  //   assert_eq!(
  //     curve.transform_proj_point(&curve.proj_point_add(&p2, &p2)).unwrap(),
  ...
  //   );
  //
  //   assert!(p11.is_inf() && x_p11.is_inf(), "p11: {p11:?}, x_p11: {x_p11:?}");
  //   {
  ...
  //   assert_eq!(&p22_mul, &EcPointP::neutral(), "p2_mul: {p2_mul:?}, p2: {p2:?}");
  ...
  //   let g = EcPointP::new(
  //     &BigInt::from_str_radix("188da80eb03090f67cbf20eb43a18800f4ff0afd82ff1012", 16).unwrap(),
  //     &BigInt::from_str_radix("07192b95ffc8da78631011ed6b24cdd573f977a11e794811", 16).unwrap(),
  //     &BigInt::one(),
  //   );
  //
  //   let order = BigUint::from_str_radix("6277101735386680763835789423176059013767194773182842284081", 10).unwrap();
  //
  //   let g2 = curve.transform_proj_point(&curve.proj_point_add(&g, &g)).unwrap();
  //   let g3 = curve.transform_proj_point(&curve.proj_point_add(&g2, &g)).unwrap();
  //   let g_rand1 = curve
  //     .transform_proj_point(
  //       &curve.proj_point_mul(
  //         &g,
  //         &BigUint::from_str_radix(
  //           "91525383471184876357591255416236519458931172413040567087697243677776850892863",
  //           10,
  //         )
  //         .unwrap(),
  //       ),
  ...
  //         &g,
  //         &BigUint::from_str_radix(
  //           "85746756882674469322490085946219637000383264126530953421180950914743422676016",
  //           10,
  //         )
  //         .unwrap(),
  //       ),
  ...
  //         &g,
  //         &BigUint::from_str_radix(
  //           "64521382629758530421575792491099066743806501416864342394520396229811324821000",
  //           10,
  //         )
  //         .unwrap(),
  //       ),
